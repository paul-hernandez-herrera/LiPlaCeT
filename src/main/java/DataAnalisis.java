...
public class DataAnalisis {
	...
	private ArrayList<int[]> list_treeNodes, list_cellCycleNodes, list_divisionTimesNodes;
	...
	public ArrayList<ArrayList<ArrayList<Double>>> get_cell_length() {
	...
	private void convert_trackingToTreeNodes() {
		...
		ArrayList<ArrayList<ArrayList<Integer>>> List_DivisionTimes = get_timeForDivision();
	...
	private ArrayList<ArrayList<ArrayList<Integer>>> get_timeForDivision(){
	...
	private ArrayList<ArrayList<ArrayList<Double>>> compute_cells_growth_rate_from_sorted_track() {
		...
		ArrayList<ArrayList<ArrayList<Double>>> cells_growth_distance = get_cell_length();
